...
//     private readonly colorChannels: number;
//     private readonly interpolationPass: boolean;
//     private readonly resizeCallback: any;
...
//     private resizeWidth: (buffer: Uint8Array | never[]) => never[] | Uint8Array;
//     private resizeHeight: (buffer: Uint8Array | never[]) => never[] | Uint8Array;
//     private heightBuffer: Uint8Array | never[];
//     private outputHeightWorkBench: Float32Array | never[];
//     private outputHeightWorkBenchOpaquePixelsCount: Float64Array | never[];
//     private widthBuffer: Uint8Array | Float32Array | never[];
//     private outputWidthWorkBench: Float32Array | never[];
//     private outputWidthWorkBenchOpaquePixelsCount: Float64Array | never[];
//     private ratioWeightWidthPass: number;
//     private ratioWeightHeightPass: number;

//     public constructor(widthOriginal: number,
...
//     public _resizeWidthInterpolatedRGBChannels(buffer: Uint8Array, fourthChannel: boolean) {
...
//     public _resizeWidthRGBChannels(buffer: Uint8Array, fourthChannel: boolean): Uint8Array | never[] {
//         const channelsNum = fourthChannel ? 4 : 3;
//         const ratioWeight = this.ratioWeightWidthPass;
...
//     public _resizeHeightRGBChannels(buffer: Uint8Array, fourthChannel: boolean) {
...
//     public resizeWidthInterpolatedRGB(buffer: Uint8Array) {
//         return this._resizeWidthInterpolatedRGBChannels(buffer, false);
//     };

//     public resizeWidthInterpolatedRGBA(buffer: Uint8Array) {
//         return this._resizeWidthInterpolatedRGBChannels(buffer, true);
//     };

//     public resizeWidthRGB(buffer: Uint8Array) {
//         return this._resizeWidthRGBChannels(buffer, false);
//     };

//     public resizeWidthRGBA(buffer: Uint8Array) {
//         return this._resizeWidthRGBChannels(buffer, true);
//     };

//     public resizeHeightInterpolated(buffer: Uint8Array): Uint8Array | never[] {
//         const ratioWeight = this.ratioWeightHeightPass;
//         const outputBuffer = this.heightBuffer;
...
//     public resizeHeightRGB(buffer: Uint8Array) {
//         return this._resizeHeightRGBChannels(buffer, false);
//     };

//     public resizeHeightRGBA(buffer: Uint8Array) {
//         return this._resizeHeightRGBChannels(buffer, true);
//     };

//     public resize(buffer: Uint8Array) {
//         this.resizeCallback(this.resizeHeight(this.resizeWidth(buffer)));
//     };

//     public bypassResizer(buffer: Uint8Array): Uint8Array {
//         // Just return the buffer passed:
//         return buffer;
//     };

//     public initializeFirstPassBuffers(BILINEARAlgo: boolean) {
...
//     private generateFloatBuffer(bufferLength: number) {
...
//     private generateFloat64Buffer(bufferLength: number) {
...
//     private generateUint8Buffer(bufferLength: number) {
